  ...
  const router = useRouter()
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
      ...
      try{
        ...
        const service_ua = await findService('ua', +values.id)
        const service_ru = await findService('ru', +values.id)
        const service_pl = await findService('pl', +values.id)
        const service_en = await findService('en', +values.id)
